const CACHE = 'creator-empire-v1.5.0';
const ASSETS = [
  './', './index.html', './styles/app.css', './manifest.webmanifest',
  './icon.svg', './simple-logo.png', './ai-sparkle.png', './styles/variables.css', './styles/base.css', './styles/layout.css', './styles/components.css', './styles/simple-v1.5.css',
  ...
  './src/app/navigation.js', './src/app/router.js', './src/app/runtime.js', './src/app/simple-shell.js',
  './src/app/selectors.js', './src/app/shell.js', './src/app/store.js', './src/app/view.js',
  './src/charts/charts.js',
  './src/controllers/ai-controller.js', './src/controllers/autopilot-controller.js', './src/controllers/command-palette.js', './src/controllers/entity-controller.js',
  ...
  './src/domain/prompts.js', './src/domain/scoring.js', './src/domain/simple-channels.js', './src/domain/simulator.js', './src/domain/types.js',
  ...
  './src/features/settings.js', './src/features/simple.js', './src/features/simulator.js', './src/main.js', './src/seed/demo.js',
