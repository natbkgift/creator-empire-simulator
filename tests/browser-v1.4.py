...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        record("Channel Workspace opens from portfolio", "Channel Blueprint" in body)
        record("Originality & Sources restored", "Originality & Sources" in body)
        record("Monetization restored contextually", "Monetization" in body)
        record("30-Day Content Plan restored", "30-Day Content Plan" in body)
        ...
        group_labels = page.locator(".flow-group-head > div > span").all_inner_texts()
